<template>
  <div class="container-fluid text-center mt-3">
    ...
    <router-link v-if="isActivated && isNetworkSupported" to="/free-domain-mint">Free Domain</router-link>
    <span v-if="isActivated && isNetworkSupported"> | </span>
    ...
    for the <a target="_blank" href="https://thebasedao.com">Based DAO</a> 
  </div>

  <div class="container-fluid text-center">

    <a class="icons" target="_blank" href="https://twitter.com/basednouns"><i class="bi bi-twitter"></i></a>
